...
import { MegaMenuComponent } from 'src/app/custom-layout/member/components/mega-menu/mega-menu.component';
import icSearch from '@iconify/icons-ic/twotone-search';
import { ColorVariable, colorVariables } from 'src/app/custom-layout/member/components/config-panel/color-variables';
import { DOCUMENT } from '@angular/common';
import { Inject } from '@angular/core';
import { Style, StyleService } from 'src/@vex/services/style.service';
import gql from 'graphql-tag';
import { Apollo } from 'apollo-angular';
import { AioTableComponent } from 'src/app/custom-layout/admin/pages/apps/aio-table/aio-table.component'
...
export class ToolbarComponent implements OnInit {
  ...
  ngOnInit() {
   ...
   let t = new Promise((resolve, reason)=>{
      this.apollo.watchQuery({
        ...
        let aioTableComponent = new AioTableComponent(null,null,null)
        this.expireDate = aioTableComponent.getDays(data.currentUser.expireDate)
        
        this.userData = {}
        resolve({
          companyName: data.currentUser.companyName,
