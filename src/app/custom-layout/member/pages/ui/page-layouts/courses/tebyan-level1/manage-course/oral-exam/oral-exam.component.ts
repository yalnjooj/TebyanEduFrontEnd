...
import { Subscription } from 'rxjs';
  ...
  export class OralExamComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'courseNo', 'level', 'catagory', 'beneficiaryType', 'courcesDates', 'startTime', 'typePlace', 'updatedAt'];
  dataSource: any
