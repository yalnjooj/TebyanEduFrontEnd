...
import { SidebarComponent } from 'src/app/custom-layout/admin/components/sidebar/sidebar.component';
              ...
              children: [
                {
                  ...
                  route: '/admin/apps/help-center/getting-started'
                },
                {
                  type: 'link',
                  label: 'Pricing & Plans',
                  route: '/admin/apps/help-center/pricing'
                },
                {
                  type: 'link',
                  label: 'FAQ',
                  route: '/admin/apps/help-center/faq'
                },
                {
                  type: 'link',
                  label: 'Guides',
                  route: '/admin/apps/help-center/guides'
                }
              ]
            },
            {
              ...
              children: [
                {
                  type: 'link',
                  label: 'Profile',
                  route: '/admin/apps/social',
                  routerLinkActiveOptions: { exact: true }
                },
                {
                  type: 'link',
                  label: 'Timeline',
                  route: '/admin/apps/social/timeline'
                },
              ]
            },
            {
              ...
              children: [
                {
                  type: 'link',
                  label: 'List - Grid',
                  route: '/admin/apps/contacts/grid',
                },
                {
                  type: 'link',
                  label: 'List - Table',
                  route: '/admin/apps/contacts/table',
                }
              ]
            },
            {
              ...
              children: [
                {
                  type: 'link',
                  label: '404',
                  route: '/admin/pages/error-404'
                },
                {
                  type: 'link',
                  label: '500',
                  route: '/admin/pages/error-500'
                }
              ]
            },
            {
              ...
              icon: icAttachMoney,
              route: '/admin/pages/pricing'
            },
            {
              type: 'link',
              label: translate.invoice,
              icon: icReceipt,
              route: '/admin/pages/invoice'
            },
            {
              type: 'link',
              label: translate.FAQ,
              ...
              children: [
                {
                  type: 'link',
                  label: 'Overview',
                  route: '/admin/ui/components/overview'
                },
                {
                  type: 'link',
                  label: 'Autocomplete',
                  route: '/admin/ui/components/autocomplete'
                },
                {
                  type: 'link',
                  label: 'Buttons',
                  route: '/admin/ui/components/buttons'
                },
                {
                  type: 'link',
                  label: 'Button Group',
                  route: '/admin/ui/components/button-group'
                },
                {
                  type: 'link',
                  label: 'Cards',
                  route: '/admin/ui/components/cards'
                },
                {
                  type: 'link',
                  label: 'Checkbox',
                  route: '/admin/ui/components/checkbox'
                },
                {
                  type: 'link',
                  label: 'Dialogs',
                  route: '/admin/ui/components/dialogs'
                },
                {
                  type: 'link',
                  label: 'Grid List',
                  route: '/admin/ui/components/grid-list'
                },
                {
                  type: 'link',
                  label: 'Input',
                  route: '/admin/ui/components/input'
                },
                {
                  type: 'link',
                  label: 'Lists',
                ...
                },
                {
                  type: 'link',
                  label: 'Progress',
                  route: '/admin/ui/components/progress'
                },
                {
                  type: 'link',
                  label: 'Progress Spinner',
                  route: '/admin/ui/components/progress-spinner'
                },
                {
                  type: 'link',
                  label: 'Radio',
                  route: '/admin/ui/components/radio'
                },
                {
                  type: 'link',
                  label: 'Slide Toggle',
                  route: '/admin/ui/components/slide-toggle'
                },
                {
                  type: 'link',
                  label: 'Slider',
                  route: '/admin/ui/components/slider'
                },
                {
                  type: 'link',
                  label: 'Snack Bar',
                  route: '/admin/ui/components/snack-bar'
                },
                {
                  type: 'link',
                  label: 'Tooltip',
                  route: '/admin/ui/components/tooltip'
                },
              ]
            },
            {
              ...
              children: [
                {
                  type: 'link',
                  label: 'Form Elements',
                  route: '/admin/ui/forms/form-elements'
                },
                {
                  type: 'link',
                  label: 'Form Wizard',
                  route: '/admin/ui/forms/form-wizard'
                }
              ]
            },
            {
              ...
              children: [
                {
                  ...
                  route: '/admin/ui/icons/ic'
                },
                {
                  type: 'link',
                  label: 'FontAwesome Icons',
                  route: '/admin/ui/icons/fa'
                }
              ]
            },
            {
                  ...
                  children: [
                    {
                      type: 'link',
                      label: 'Default',
                      route: '/admin/ui/page-layouts/card',
                      routerLinkActiveOptions: { exact: true }
                    },
                    {
                      type: 'link',
                      label: 'Tabbed',
                      route: '/admin/ui/page-layouts/card/tabbed',
                    },
                    {
                      type: 'link',
                      label: 'Large Header',
                      route: '/admin/ui/page-layouts/card/large-header',
                      routerLinkActiveOptions: { exact: true }
                    },
                    {
                      type: 'link',
                      label: 'Tabbed & Large Header',
                      route: '/admin/ui/page-layouts/card/large-header/tabbed'
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      type: 'link',
                      label: 'Default',
                      route: '/admin/ui/page-layouts/simple',
                      routerLinkActiveOptions: { exact: true }
                    },
                    {
                      type: 'link',
                      label: 'Tabbed',
                      route: '/admin/ui/page-layouts/simple/tabbed',
                    },
                    {
                      type: 'link',
                      label: 'Large Header',
                      route: '/admin/ui/page-layouts/simple/large-header',
                      routerLinkActiveOptions: { exact: true }
                    },
                    {
                      type: 'link',
                      label: 'Tabbed & Large Header',
                      route: '/admin/ui/page-layouts/simple/large-header/tabbed'
                    }
                  ]
                },
                {
                  ...
                  route: '/admin/ui/page-layouts/blank'
                },
              ]
            },
          ]
          ...
          children: [
            {
              ...
              route: '/admin/documentation/changelog',
              icon: icUpdate
            },
            {
              type: 'dropdown',
              ...
              children: [
                {
                  type: 'link',
                  label: 'Introduction',
                  route: '/admin/documentation/introduction',
                ...
                },
                {
                  ...
                  route: '/admin/documentation/folder-structure',
                ...
                },
                {
                  type: 'link',
                  label: 'Installation',
                  route: '/admin/documentation/installation',
                ...
                },
                {
                  ...
                  route: '/admin/documentation/start-development-server',
                ...
                },
                {
                  ...
                  route: '/admin/documentation/build-for-production',
              ...
              children: [
                {
                  type: 'link',
                  label: 'Configuration',
                  route: '/admin/documentation/configuration',
                ...
                },
                {
                  ...
                  route: '/admin/documentation/changing-styling-and-css-variables',
                ...
                },
                {
                  ...
                  route: '/admin/documentation/using-custom-colors-for-the-primarysecondarywarn-palettes',
                ...
                },
                {
                  ...
                  route: '/admin/documentation/adding-menu-items',
            ...
            },
            {
              ...
              icon: icBook,
              route: '/admin/documentation/further-help',
