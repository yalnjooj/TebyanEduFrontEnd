import { Mail } from 'src/app/custom-layout/admin/pages/apps/mail/interfaces/mail.interface';
import faker from 'faker/locale/en';
import { MailLabel } from 'src/app/custom-layout/admin/pages/apps/mail/interfaces/mail-label.interface';
import { MailAttachment } from 'src/app/custom-layout/admin/pages/apps/mail/interfaces/mail-attachment.interface';
